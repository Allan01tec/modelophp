        ...
        <tbody>
           ...
           <?php do{ ?>
            <tr>
                ...
                <td><a href="usuarios_atualiza.php?id=<?php echo $row['id']?>" class="btn btn-warning btn-block btn-sm">
                       
                        <span class="glyphicon glyphicon-refresh" aria-hidden="true">ALTERAR</span>
                    </a>
                    <button data-nome="<?php echo $row['login']?>" data-id="<?php echo $row['id']?>" class="delete btn btn-danger btn-block btn-sm">
