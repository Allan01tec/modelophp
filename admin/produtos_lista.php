...
$row = $lista->fetch_assoc(); // primeiro registro que ele buscar no array
$rows = $lista->num_rows;// quantidade que terei no registro (qunatos ela retornou)
?>
                     ...
                     echo $row ['id'];?>       
                        ...
                        <td>
                            ...
                            if($row['destaque']=='Sim'){
                                ...
                                echo '<span class="glyphicon glyphicon-star text-danfer"
                                aria-hidden="true"></span';
                            }
                            else
                            //caso contrario, exibe icone ok - success
                            {
                        ...
                        <td>
                            <a
                                ...
                                //passa o ID do produto para a pagina de atualização
                                echo $row['id'];?>" 
                                role="button" 
                            ...
                            >
                                ...
                                <?php 
                                //executar uma query para verificar o status de destaque do produto atual
                            ...
                            <button 
                                data-nome=""<?php 
                                //degine o atributo data-nome com a descrição do produto
                                echo $row['descricao'];
                                ?>
                                data-id=""<?php 
                                echo $row['id'];?>
                                ...
                                <?php 
                                echo $regraRow['destaque'] =='Sim' ? 'hidden' : '';?>
                                "     
                            >
